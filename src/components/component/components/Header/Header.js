                                ...
                                <div className="right-box">
                                    <ul className="nav nav-pills" id="pills-tab" role="tablist">
                                        <li className="nav-item" role="presentation">
                                            <button className="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">Connect Wallet</button>
                                        </li>
                                        {/* <li className="nav-item" role="presentation">
                                            ...
                                            <div className="exchange">
                                                    ...
                                                    <div className="selector">
                                                        ...
                                                        <div className="coin">
                                                            ...
                                                            <div className="language-select">
                                                                ...
                                                                </select><div className="nice-select select-bar" tabIndex="0"><span className="current">BNB</span><ul className="list"><li data-value="" className="option selected focus">BNB</li><li data-value="" className="option">USD</li><li data-value="" className="option">BTC</li></ul></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <form action="#">
                                                        <div className="form-group">
                                                            <input type="text" name="number" placeholder="1 BNB" className="form-control" onChange={(e)=>setBnb(e.target.value)} />
                                                        </div>
                                                    </form>
                                                ...
                                                <div className="content">
                                                    <div className="text-box">
                                                        <p className="text"> <span className="one">Daily ROI</span> <span className="two">10% BNB</span></p>
                                                        <p className="text"> <span className="one">Total Profit</span> <span className="two">300% BNB</span></p>
                                                    </div>
                                                    <div className="earn">
                                                        <p className="text">You’ll Earn in 30 days</p>
                                                        <p className="text two">{bnb*3} BNB</p>
                                                    </div>
                                                </div>

                                                <div className="button-box">
                                                    <a href="#" className="button button-1">Stake Now</a>
                                                </div>
                                            </div>
                                        </div>
